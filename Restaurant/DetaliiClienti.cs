...
{
    public partial class DetaliiClienti : Form
    {
        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
           ...
           frm.Show();
           frm.txtIdClient.Text = dr.Cells[0].Value.ToString();
           frm.txtNumeClient.Text = dr.Cells[1].Value.ToString();
           frm.txtAdresa.Text = dr.Cells[2].Value.ToString();
           frm.txtOras.Text = dr.Cells[3].Value.ToString();
           frm.txtMobil.Text = dr.Cells[4].Value.ToString();
           frm.txtTelefon.Text = dr.Cells[5].Value.ToString();
           frm.txtEmail.Text = dr.Cells[6].Value.ToString();
           frm.txtObservatii.Text = dr.Cells[7].Value.ToString();
           frm.btnActualizare.Enabled = true;
           frm.btnSterge.Enabled = true;
           frm.btnSalveaza.Enabled = false;
           frm.txtNumeClient.Focus();
             }
